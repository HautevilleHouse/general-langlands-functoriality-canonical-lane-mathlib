/-!
# general-langlands-functoriality-canonical-lane Lean migration boundary
...
`GeneralLanglandsFunctorialityCanonicalLaneLean/SourcePackage.lean`.
...
def sourceRepository : String := "general-langlands-functoriality-canonical-lane"
def sourceUrl : String := "https://github.com/HautevilleHouse/general-langlands-functoriality-canonical-lane"
def sourceDescription : String := "Canonical-lane closure package for General Langlands functoriality: admissible-class formulation, projection gates, local-to-global bridge, and carried remainder."
def sourceClassification : String := "abstract_math_theorem_repo"
def sourceTopics : List String := ["galois-representations", "langlands-program", "mathematical-proof", "reproducibility", "automorphic-representations", "functoriality", "trace-formula", "canonical-lane", "local-to-global", "manifold-constrained"]
