# General Langlands Functoriality — Canonical Lane Mathlib
...
```bash
git clone https://github.com/HautevilleHouse/general-langlands-functoriality-canonical-lane-mathlib.git
cd general-langlands-functoriality-canonical-lane-mathlib
lake exe
lake build
```
